...
function Search() {
    ...
    const pasteToInput = async (type: 'mess' | 'engine', idx: number) => {
    ...
    const pasteSearch = async (item: UEngineItem | UMessItem, idx: number, type: 'mess' | 'engine') => {
                ...
                {messList.map((item, idx) =>
                    ...
                    >
                        <Input.Search
                            ...
                            enterButton={<Icon style={{ width: 20 }} component={() => Icon_Map.get(item.id) || null as any} />}
                            allowClear
                            size="large"
                        />
                        <Button className="paste-s" onClick={() => pasteSearch(item, idx, 'mess')}>s</Button>
                    </div>
                )}
